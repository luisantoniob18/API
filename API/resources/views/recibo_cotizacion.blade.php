...
<body>
    <div class="header">
        <h1>Cotización #: 000{{ $cotizacion->IdCotizacion }}</h1>
    ...
    <div class="details">
        ...
        <p><strong>Dirección de Entrega:</strong> {{ $cotizacion->Destino }}</p>
    </div>
    ...
    <p class="total">Total: Q{{ number_format($cotizacion->Total, 2) }}</p>

    <div class="footer">
        <p style="color: #FFD700;">Gracias por su interés en nuestros productos</p>
        <p>Por favor conserve esta cotización para futuras referencias.</p>
    </div>
</body>
</html>
